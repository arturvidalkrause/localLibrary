...
exports.genre_create_post = [
    ...
    asyncHandler(async (req, res, next) => {
        ...
        // Create a genre object with escaped and trimmedd data
        const genre = new Genre({name: req.body.name});

        if (!errors.isEmpty()) {
            // Thre are errors. Render thr form again sanitized values/error messages
            ...
            // Check if Genre with same name alredy exists
